package dev.mortus.util.math.ranges;
...
import dev.mortus.util.math.vectors.Int2D.StoredBit;
import dev.mortus.util.math.vectors.Int2D.StoredByte;
import dev.mortus.util.math.vectors.Int2D.StoredFloat;
