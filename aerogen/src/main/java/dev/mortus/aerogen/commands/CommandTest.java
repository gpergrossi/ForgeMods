package dev.mortus.aerogen.commands;
...
public class CommandTest implements ICommand {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		WorldServer dim2 = server.worldServerForDimension(2);
		...
		if (args.length == 0) {
			...
			else throw new CommandException("Invalid arguments for command block");
		}
