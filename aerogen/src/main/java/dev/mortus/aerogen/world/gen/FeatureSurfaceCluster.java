...
public class FeatureSurfaceCluster extends Feature {
	...
	public FeatureSurfaceCluster addPlacable(float weight, Placeable placeable) {
	...
	protected Placeable getRandomPlaceable(Random rand) {
	...
	public boolean generate(World world, Island island, BlockPos position, Random rand) {
        ...
        for (int i = 0; i < clusterDensity; i++) {
            ...
            Placeable placeable = getRandomPlaceable(rand);
