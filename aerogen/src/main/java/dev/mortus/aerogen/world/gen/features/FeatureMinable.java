...
public class FeatureMinable extends AbstractFeature {
	...
	public FeatureMinable allowUndersideVisibleChance(double chance) {
		this.chanceAllowUnderside = chance;
		return this;
	}
