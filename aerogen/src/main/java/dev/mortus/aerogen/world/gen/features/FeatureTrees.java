...
public class FeatureTrees extends AbstractFeature {
	...
	public boolean generate(World world, Island island, BlockPos position, Random rand) {
 	...
 	private static final IBlockState NO_DECAY_LEAF = Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
 	private static final IBlockState NO_DECAY_LEAF2 = Blocks.LEAVES2.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
