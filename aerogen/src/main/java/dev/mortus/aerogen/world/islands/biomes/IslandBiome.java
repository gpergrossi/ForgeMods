...
import dev.mortus.aerogen.world.gen.features.FeatureMinable;
import dev.mortus.aerogen.world.gen.features.FeatureSurfaceCluster;
import dev.mortus.aerogen.world.gen.features.FeatureUnderwaterBlocks;
...
import dev.mortus.aerogen.world.gen.placement.PlacementIslandInterior;
import dev.mortus.aerogen.world.gen.placement.PlacementWaterSurface;
...
public abstract class IslandBiome extends Biome {
	...
	public static void addDefaultWaterFeatures(IslandDecorator decorator) {
		...
		decorator.addFeature(
			new FeatureUnderwaterBlocks(Blocks.DIRT, 3)
			.withPlacement(
				new PlacementWaterSurface()
				.withDesiredCount(1)
			)
		...
		decorator.addFeature(
			new FeatureUnderwaterBlocks(Blocks.GRAVEL, 4)
			.withPlacement(
				new PlacementWaterSurface()
				.withDesiredCount(1)
			)
