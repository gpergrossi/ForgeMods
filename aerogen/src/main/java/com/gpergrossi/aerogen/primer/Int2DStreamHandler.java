...
public class Int2DStreamHandler implements IStreamHandlerFixedSize<Int2D> {

	public static Int2DStreamHandler INSTANCE = new Int2DStreamHandler();
	
	private Int2DStreamHandler() { }
