...
public class Placeables {
    ...
    public static final IPlaceable FOREST_ROCK = new PlaceableMinecraftGeneric(new WorldGenBlockBlob(Blocks.MOSSY_COBBLESTONE, 0));
    public static final IPlaceable GIANT_MUSHROOM = new PlaceableMinecraftGeneric(new WorldGenBigMushroom());
