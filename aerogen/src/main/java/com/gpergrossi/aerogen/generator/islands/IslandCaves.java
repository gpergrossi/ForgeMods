...
public class IslandCaves {
	...
	public static FractalNoise2D turbulenceX = FractalNoise2D.builder().withSeed(87483211L).withPeriod(32).withOctaves(4).build();
	public static FractalNoise2D turbulenceY = FractalNoise2D.builder().withSeed(-589043136L).withPeriod(32).withOctaves(4).build();
	public static FractalNoise2D turbulenceZ = FractalNoise2D.builder().withSeed(1998491627635L).withPeriod(32).withOctaves(4).build();
